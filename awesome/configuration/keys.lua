...
awful.keyboard.append_global_keybindings({
	...
	awful.key({ modkey }, "k", function()
		awful.screen.focus_bydirection("up", mouse.screen)
	end, { description = "- Focus to next Screen above", group = "Screens" }),
	awful.key({ modkey }, "j", function()
		awful.screen.focus_bydirection("down", mouse.screen)
	end, { description = "- Focus to next Screen below", group = "Screens" }),
	...
	-- end, { description = "- Decrease Device Volume", group = "Media" }),
	-- awful.key({}, "0x1008ffb1", function()
	-- 	awful.spawn.with_shell("wpctl set-volume @DEFAULT_SINK@ 5%+")
	-- 	awesome.emit_signal("audio::update_slider", awful.screen.focused())
	-- end, { description = "- Increase Device Volume", group = "Media" }),
	-- awful.key({}, "0x1008ffb2", function()
	-- 	awful.spawn.with_shell("playerctl play-pause")
	-- end, { description = "- Toggle Play/Pause", group = "Media" }),
	-- -- F13
	-- awful.key({}, "0x1008ff47", function()
	-- 	toggleMicMute()
